// Se aconseja proteger la clase. asi, quien utilice la clase no podra modificar las propiedades
//internas de la clase

//pivate no permite modficar las propiedades internas de la clase
//private me permite entonces ¨encapsular¨ y ¨proteger¨ para tener solamente ¨acceso interno¨
// por esa razon se puede realizar un metodo en el cual tenga los datos de la clase para que puedan ser vistos.
